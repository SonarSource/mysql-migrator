...
public class StartApp {
  ...
  public static void main(String[] args) {
    new StartApp().parseArgsAndRunMigration(args);
  }

  void parseArgsAndRunMigration(String[] args) {
  ...
  private static void runMigration(Arguments arguments) {
    String starLine = "****************";
    ...
    ConnecterData connecterDataSource = new ConnecterData(
      arguments.getSourceDriver(),
      arguments.getSourceUrl(),
      arguments.getSourceUser(),
      arguments.getSourcePassword()
    );
    ConnecterData connecterDataDest = new ConnecterData(
      arguments.getTargetDriver(),
      arguments.getTargetUrl(),
      arguments.getTargetUser(),
      arguments.getTargetPassword()
    );

    int commitSize = arguments.getCommitSize();
    ...
    metadataGetterSource.execute(null);
    ...
    metadataGetterDest.execute(null);
