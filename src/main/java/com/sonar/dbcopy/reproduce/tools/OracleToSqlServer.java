...
public class OracleToSqlServer implements CopierTool {

  private PreparedStatement destinationStatement;

  public OracleToSqlServer(PreparedStatement destinationStatement) {
  ...
  public void copyClob(ResultSet resultSetSource, int indexColumn) throws IOException, SQLException {
    copyBlob(resultSetSource, indexColumn);
  }
